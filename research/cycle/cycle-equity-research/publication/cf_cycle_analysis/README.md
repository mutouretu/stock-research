...
scripts/generate_cycle_state_figure.py M4.3 state timeline
...
stability and multiple-testing labels. The cycle-state figure reads the complete M4.3 JSON report;
the publication never recomputes or manually copies state labels.
