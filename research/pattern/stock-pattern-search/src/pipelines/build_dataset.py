...
def main(config_path: str = "configs/common/data.yaml") -> Dict[str, Any]:
    ...
    if not bool(config.get("skip_precheck", False)):
        _precheck_or_raise(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="configs/common/data.yaml", help="Path to data config yaml")
