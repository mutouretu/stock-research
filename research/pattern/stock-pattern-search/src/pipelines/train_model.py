...
def main(config_path: str = "configs/common/train.yaml") -> Dict[str, float]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="configs/common/train.yaml", help="Path to train config yaml")
